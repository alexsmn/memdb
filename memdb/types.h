...
template <typename T>
inline DBType GetDBType(T);
template <>
inline DBType GetDBType(DBUInt8) {
  return DB_UINT8;
}
template <>
inline DBType GetDBType(DBUInt16) {
  return DB_UINT16;
}
template <>
inline DBType GetDBType(DBUInt32) {
  return DB_UINT32;
}
template <>
inline DBType GetDBType(const char*) {
  return DB_STRING;
}
template <>
inline DBType GetDBType(double) {
  return DB_FLOAT;
}

template <typename T>
inline T GetNullValue(T);
template <>
inline DBUInt8 GetNullValue(DBUInt8) {
  return NULL_UINT8;
}
template <>
inline DBUInt16 GetNullValue(DBUInt16) {
  return NULL_UINT16;
}
template <>
inline DBUInt32 GetNullValue(DBUInt32) {
  return NULL_UINT32;
}
template <>
inline const char* GetNullValue(const char*) {
  return NULL;
}
template <>
inline DBFloat GetNullValue(DBFloat) {
  return NULL_FLOAT;
}
...
inline bool FloatToBool(double value) {
  return value != 0.0;
}
inline double BoolToFloat(bool value) {
